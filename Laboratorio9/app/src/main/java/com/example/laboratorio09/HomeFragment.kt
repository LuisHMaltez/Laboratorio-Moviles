...
class HomeFragment : Fragment() {
    ...
    private fun listeners(){
        binding.coroutinesButton.setOnClickListener{
            it.findNavController().navigate(R.id.action_homeFragment2_to_coroutinesFragment)
        }

        binding.mainThreadButton.setOnClickListener {
                it.findNavController().navigate(R.id.action_homeFragment2_to_mainThreadFragment)
            }
        }
    }